...
INDEX_PREFIX="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_build_results/trinity_assembly_after_trimmomatic/trinity_assembly_after_trimmomatic"
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    OUTDIR="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_trimmomatic/${SAMPLE}"
