...
salmon quant -i /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_index/salmon_index_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/transcripts_index_after_cdhitest_trinity_NCBI_FCS_transrate_filtering \
-l ISR \
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR11266554_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR11266555_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR11266556_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690969_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690970_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690971_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690972_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690973_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
...
-p 16 \
--validateMappings \
-o /media/raid/Wee/WeeYeZhi/output/salmon_results/salmon_quantify/salmon_quantify_after_cdhitest_trinity_NCBI_FCS_transrate_filtering/quant_SRR9690974_after_cdhitest_trinity_NCBI_FCS_transrate_filtering
