...
INDEX_PREFIX="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_build_results/trinity_assembly_after_cdhitest_trinity_NCBI_FCS/trinity_assembly_after_cdhitest_trinity_NCBI_FCS"
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    OUTDIR="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_cdhitest_trinity_NCBI_FCS/${SAMPLE}"
