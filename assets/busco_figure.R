...
# Output
my_output <- paste("/mnt/c/Users/USER/Documents/Master_of_Science_in_Systems_Biology_GRA/Experimental_work/Mac2025-Aug2025/output/BUSCO_plot/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('MaSuRCA', 'MaSuRCA', 'MaSuRCA', 'MaSuRCA', 'Flye', 'Flye', 'Flye', 'Flye', 'SPAdes_only_assemble', 'SPAdes_only_assemble', 'SPAdes_only_assemble', 'SPAdes_only_assemble', 'SPAdes_full_pipeline', 'SPAdes_full_pipeline', 'SPAdes_full_pipeline', 'SPAdes_full_pipeline', 'MaSuRCA_4_Racon_POLCA', 'MaSuRCA_4_Racon_POLCA', 'MaSuRCA_4_Racon_POLCA', 'MaSuRCA_4_Racon_POLCA', 'Flye-meta', 'Flye-meta', 'Flye-meta', 'Flye-meta')
...
my_percentage <- c(41.5, 1.8, 14.3, 42.4, 38.4, 1.1, 14.3, 46.2, 28.1, 0.1, 33.7, 38.1, 18.4, 0.2, 36.5, 44.9, 41.2, 0.5, 14.4, 43.9, 38.8, 1.1, 14.3, 45.8)
my_values <- c(2393, 102, 821, 2444, 2213, 64, 822, 2661, 1620, 7, 1941, 2192, 1057, 12, 2104, 2587, 2375, 26, 828, 2531, 2233, 63, 826, 2638)
