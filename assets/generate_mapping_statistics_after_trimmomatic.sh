...
do
    ...
    SAM_FILE="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_trimmomatic/${sample}/${sample}.sam"
    BAM_FILE="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_trimmomatic/${sample}/${sample}.bam"
    SORTED_BAM_FILE="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_trimmomatic/${sample}/${sample}.sorted.bam"
    FLAGSTAT_FILE="/media/cbr14/Two/Wee/WeeYeZhi/output/bowtie2_results/bowtie2_mapping_results/trinity_assembly_after_trimmomatic/${sample}/${sample}.flagstat"
