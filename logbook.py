...
if selected == "Phase 3: Molecular Docking and Dynamics Simulation":
    with st.container():
       ...
       """, language="bash")
        ...
        st.write("✔️open the whole_protein_cluster_centers_0.13.pdb file in UCSF ChimeraX interface and extract the top 3 representative clusters in PDB format after running the GROMOS clustering process")
        st.code("""
        cd C:\\Users\\USER\\Documents\\Master_of_Science_in_Systems_Biology_GRA\\Experimental_results\\charmmgui_results
        save apo_cluster1.pdb models #1.1
        save apo_cluster2.pdb models #1.2
        save apo_cluster3.pdb models #1.3 
        """, language="bash")
        st.write("✔️perform structural superimposition between the TM helices region of the top 3 dominant clusters to investigate whether there is any large conformational change during the simulation in terms of their RMSD values")
        st.code("""
        select and delete the #1,4, #1.5, #1.6 and #1.7 models manually in the UCSF ChimeraX interface
        color #1.1-3:31-54 red target c # color the clustered TM1 region (cartoon representation) as red
        color #1.1-3:66-87 light sea green target c  # color the clustered TM2 region (cartoon representation) as light sea green
        color #1.1-3:104-125 orange red target c # color the clustered TM3 region (cartoon representation) as orange red
        color #1.1-3:146-167 green target c # color the clustered TM4 region (cartoon representation) as green
        color #1.1-3:195-215 blue target c  # color the clustered TM5 region (cartoon representation) as blue
        color #1.1-3:279-298 violet target c # color the clustered TM6 region (cartoon representation) as violet
        color #1.1-3:311-334 indigo target c # color the clustered TM7 region (cartoon representation) as indigo
        name TM1 #1.1:31-54,66-87,104-125,146-167,195-215,279-298,311-334 # name the TM region of top first CPB OctB2R cluster as TM1
        name TM2 #1.2:31-54,66-87,104-125,146-167,195-215,279-298,311-334 # name the TM region of top second CPB OctB2R cluster as TM2
        name TM3 #1.3:31-54,66-87,104-125,146-167,195-215,279-298,311-334 # name the TM region of top third CPB OctB2R cluster as TM3
        matchmaker TM2 to TM1 # the refined RMSD value is 0.771 angstroms
        matchmaker TM3 to TM1 # the refined RMSD value is 0.681 angstroms
        preset "overall look" "publication 1 (silhouettes)"
        select clear # remember to clear selection before rendering and saving the image
        save "C:/Users/USER/Documents/Master_of_Science_in_Systems_Biology_GRA/Experimental_results/charmmgui_results/superimposed_TM_region_of_top_three_representative_clusters_of_CcOctB2R.cxs"
        """, language="bash")
        st.write("✔️perform structural superimposition between the ligand binding site of the top 3 dominant clusters to investigate whether there is any large conformational change during the simulation in terms of their RMSD values")
        st.code("""
        cd C:\\Users\\USER\\Documents\\Master_of_Science_in_Systems_Biology_GRA\\Experimental_results\\charmmgui_results
        open apo_cluster1.pdb
        open apo_cluster2.pdb
        open apo_cluster3.pdb
        select #1:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321; show sel target ab # select the ligand binding residues of the top first CPB OctB2R cluster and show them in atom and bond (stick) representation
        select #1; cartoon hide sel # hide the cartoon representation of structure #1.1
        select #2:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321; show sel target ab # select the ligand binding residues of the top second CPB OctB2R cluster and show them in atom and bond (stick) representation
        select #2; cartoon hide sel # hide the cartoon representation of structure #1.2
        select #3:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321; show sel target ab # select the ligand binding residues of the top third CPB OctB2R cluster and show them in atom and bond (stick) representation
        select #3; cartoon hide sel # hide the cartoon representation of structure #1.3
        delete H # delete all the hydrogen atoms attached the residues to simplify the ligand binding site representation otherwise the superposed ligand binding site is going to look very crowded and complex
        select #1:105 | #2:105 | #3:105; 2dlabel create gpcr328 text "3.28x28" # collectively label the residues as 3.28x28
        2dlabel change gpcr328 size 12 # change the size of the label to 12. After changing the size of the label, you can change the 'right mouse' setting in UCSF ChimeraX GUI Interface to use the right click function to move and arrange the label around
        select #1:109 | #2:109 | #3:109; 2dlabel create gpcr332 text "3.32x32"
        2dlabel change gpcr332 size 12
        select #1:110 | #2:110 | #3:110; 2dlabel create gpcr333 text "3.33x33"
        2dlabel change gpcr333 size 12
        select #1:113 | #2:113 | #3:113; 2dlabel create gpcr336 text "3.36x36"
        2dlabel change gpcr336 size 12
        select #1:188 | #2:188 | #3:188; 2dlabel create gpcr4552 text "45.52x52"
        2dlabel change gpcr4552 size 12
        select #1:194 | #2:194 | #3:194; 2dlabel create gpcr539 text "5.38x39"
        2dlabel change gpcr539 size 12
        select #1:198 | #2:198 | #3:198; 2dlabel create gpcr543 text "5.42x43"
        2dlabel change gpcr543 size 12
        select #1:199 | #2:199 | #3:199; 2dlabel create gpcr544 text "5.43x44"
        2dlabel change gpcr544 size 12
        select #1:202 | #2:202 | #3:202; 2dlabel create gpcr546 text "5.46x461"
        2dlabel change gpcr546 size 12
        select #1:290 | #2:290 | #3:290; 2dlabel create gpcr648 text "6.48x48"
        2dlabel change gpcr648 size 12
        select #1:293 | #2:293 | #3:293; 2dlabel create gpcr651 text "6.51x51"
        2dlabel change gpcr651 size 12
        select #1:294 | #2:294 | #3:294; 2dlabel create gpcr652 text "6.52x52"
        2dlabel change gpcr652 size 12
        select #1:297 | #2:297 | #3:297; 2dlabel create gpcr655 text "6.55x55"
        2dlabel change gpcr655 size 12
        select #1:313 | #2:313 | #3:313; 2dlabel create gpcr734 text "7.35x34"
        2dlabel change gpcr734 size 12
        select #1:317 | #2:317 | #3:317; 2dlabel create gpcr738 text "7.39x38"
        2dlabel change gpcr738 size 12
        select #1:321 | #2:321 | #3:321; 2dlabel create gpcr742 text "7.43x42"
        2dlabel change gpcr742 size 12
        name site1 #1:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321 # name the ligand binding site of the top first CPB OctB2R cluster as site1
        name site2 #2:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321 # name the ligand binding site of the top second CPB OctB2R cluster as site2
        name site3 #3:105,109,110,113,188,194,198,199,202,290,293,294,297,313,317,321 # name the ligand binding site of the top third CPB OctB2R cluster as site3
        matchmaker site2 to site1 # the refined RMSD value is 0.647 angstroms
        matchmaker site3 to site1 # the refined RMSD value is 0.562 angstroms
        preset "overall look" "publication 1 (silhouettes)"
        select clear # remember to clear selection before rendering and saving the image
        save "C:/Users/USER/Documents/Master_of_Science_in_Systems_Biology_GRA/Experimental_results/charmmgui_results/superimposed_ligand_binding_site_of_top_three_representative_clusters_of_CcOctB2R.cxs"
        """, language="bash")

        st.write("###")

        st.write("**23. set grid box using AutoDock MGL Tools, followed by installing and running AutoDock Vina on Linux to dock the same set of 15 ligands to the 3 different conformational clusters of CPBOctB2R to perform ensemble docking**")
        st.write("✔️determine the CPU architecture of your computer, followed by downloading the vina_1.2.7_linux_x86_64 release package and making the package executable")
        st.code("""
        ...
        st.write("✔️perform molecular docking via AutoDock Vina (for apocluster between 600ns and 1000ns)")
        st.code("""
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-7882792398/gromacs/apo_cluster1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_1480785.pdbqt --scoring vinardo --center_x -0.215 --center_y 1.596 --center_z -8.776 --size_x 70 --size_y 60 --size_z 65 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster1.pdbqt --cpu 16 --exhaustiveness 32 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster1.log 2>&1 &
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-7882792398/gromacs/apo_cluster2.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_1480785.pdbqt --scoring vinardo --center_x -0.215 --center_y 1.596 --center_z -8.776 --size_x 70 --size_y 60 --size_z 65 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster2.pdbqt --cpu 16 --exhaustiveness 32 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster2.log 2>&1 &
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-7882792398/gromacs/apo_cluster3.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_1480785.pdbqt --scoring vinardo --center_x -0.215 --center_y 1.596 --center_z -8.776 --size_x 70 --size_y 60 --size_z 65 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster3.pdbqt --cpu 16 --exhaustiveness 32 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785_apocluster3.log 2>&1 &
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-7882792398/gromacs/apo_cluster1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_18526103.pdbqt --scoring vinardo --center_x -0.215 --center_y 1.596 --center_z -8.776 --size_x 70 --size_y 60 --size_z 65 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103_apocluster1.pdbqt --cpu 16 --exhaustiveness 32 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103_apocluster1.log 2>&1 &
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-7882792398/gromacs/apo_cluster2.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_18526103.pdbqt --scoring vinardo --center_x -0.215 --center_y 1.596 --center_z -8.776 --size_x 70 --size_y 60 --size_z 65 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103_apocluster2.pdbqt --cpu 16 --exhaustiveness 32 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/Conformer3D_COMPOUND_CID