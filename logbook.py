...
if selected == "Phase 1: Sequence-Based Analysis":
    with st.container():
        ...
        nohup cd-hit-est -i /media/raid/Wee/WeeYeZhi/output/trinity_results/trinity_assembly_done_by_LKM_and_INBIOSIS_except_pupa/trinity_assembly_done_by_LKM_and_INBIOSIS_except_pupa.Trinity.fasta -o /media/raid/Wee/WeeYeZhi/output/cd_hit_est_results/cd_hit_est_after_trimmomatic_without_pupa -c 0.95 -n 5 -T 4 > cd_hit_est_after_trimmomatic_without_pupa_output.log 2>&1 & # Remember the -o flag specifies the output filename, not the output directory, so please dont create a directory called cd_hit_est_after_trimmomatic_without_pupa. Just run this command within the working directory, /media/raid/Wee/WeeYeZhi/output/cd_hit_est_results. specify fewer number of threads (use -T 4 in this case) if possible to avoid encountering OutofMemory error. 
        """, language="bash")
        ...
        nohup perl /media/raid/Wee/WeeYeZhi/output/get_longest_isoform_per_Trinity_gene_results/get_longest_isoform_seq_per_trinity_gene.pl /media/raid/Wee/WeeYeZhi/output/cd_hit_est_results/cd_hit_est_after_trimmomatic_without_pupa/cd_hit_est_after_trimmomatic_without_pupa.fasta > /media/raid/Wee/WeeYeZhi/output/get_longest_isoform_per_Trinity_gene_results/longest_isoform_per_gene_after_cdhitest_trinity_without_pupa.fasta 2> /media/raid/Wee/WeeYeZhi/output/get_longest_isoform_per_Trinity_gene_results/error_after_cdhitest_trinity_without_pupa_output.log &
        """, language="bash")
...
if selected == "Phase 3: Molecular Docking and Dynamics Simulation":
    with st.container():
       ...
       """, language="bash")
        ...
        st.code("""
        gmx make_ndx -f protein.tpr -o index.ndx # create TM and ECL index. Type, r 31-54 | r 66-87 | r 104-125 | r 146-167 | r 188 | r 190 | r 194 | r 195-215 | r 279-298 | r 311-334, and press "Enter", followed by typing, name 10 TM_ecl_helices, to rename the newly created index group as TM_ecl_helices and position the newly created index group as 10. Type "q" to quit
        gmx make_ndx -f protein.tpr -n index.ndx -o index.ndx # create TM and ECL backbone index. Type, 10 & 4 (10 indicates TM_ecl_helices and 4 indicates backbone), and press "Enter", followed by typing, name 11 TM_ecl_helices_backbone, to rename the newly created index group as TM_ecl_helices_backbone and position the newly created index group as 11. Type "q" to quit
        """, language="bash")
        ...
        st.write("Note: To save the trajectory in mpg format using VMD, click 'Movie Maker' programme in the VMD interface -> click the 'Renderer' tab and choose 'TachyonL-OptiX (Internal GPU Ray Tracer)' -> Click the 'Movie Settings' tab and choose 'Trajectory' -> click the 'Format' tab and choose 'MPEG-2 (ffmpeg)' -> set your output working directory to save your trajectory file -> name the trajectory file that you want to save -> click 'Make Movie'.")

        st.write("###")

        st.write("Note: To color & label your protein structure and the lipid bilayer separately in the VMD interface, left click the 'Graphics' tab -> left click to select the first selection (all) -> left click the green + button located at the bottom right corner of the VMD interface. Then, after adding a new graphics style, left click to select it -> change the selection from all to protein (delete 'all' and type 'protein' manually in the selection searchbox, followed by pressing the 'enter' button in your keyboard) -> change the style from 'Lines' to 'NewCartoon' -> change the color from 'name' to 'molecule'. After that, left click the Colors tab -> choose by left clicking 'Molecule' in the Color (Categories) tab -> left click the '0' in the Color (Names) tab -> choose by left clicking the color that you want to color your protein structure (annotated as Molecule). Then, left click the 'Graphics' tab -> left click to select the first selection (all) -> change the selection from all to not protein (delete 'all' and type 'not protein' manually in the selection searchbox, followed by pressing the 'enter' button in your keyboard) to annotate the rest of the molecules as non-protein")

        st.write("###")

        st.write("Note: To change the visual representation of your protein-lipid bilayer complex model, you can change the 'Material' tab from 'Opaque' to 'Transparent' to make your lipid bilayer transparent only so that you can visualize the embedded protein structure clearly.")
        ...
        st.code("""
        mkdir -p Conformer3D_COMPOUND_CID_1480785 Conformer3D_COMPOUND_CID_18526103 Conformer3D_COMPOUND_CID_19606232 Conformer3D_COMPOUND_CID_255273 Conformer3D_COMPOUND_CID_26451 Conformer3D_COMPOUND_CID_26752 Conformer3D_COMPOUND_CID_4184 Conformer3D_COMPOUND_CID_4581 Conformer3D_COMPOUND_CID_577782 Conformer3D_COMPOUND_CID_76145148 Conformer3D_COMPOUND_CID_36324 Conformer3D_COMPOUND_CID_36326 Conformer3D_COMPOUND_CID_2726 Conformer3D_COMPOUND_CID_5775 Conformer3D_COMPOUND_CID_8969 # create a list of ligand directories first before running AutoDock Vina to organize the docking results systematicaly
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-protein-lipid-bilayer-complex/gromacs/whole_protein_cluster_centers_0.175_900_1000ns.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_2726.pdbqt --scoring vinardo --center_x -0.675 --center_y 3.513 --center_z -8.578 --size_x 29.25 --size_y 25.5 --size_z 29.25 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_CcOctB2R.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_CcOctB2R.log 2>&1 & # run this command in the working directory containing the installed executable AutoDock Vina package, /media/raid/Wee/WeeYeZhi/output/autodockvina_installation
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_CcOctB2R.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-protein-lipid-bilayer-complex/gromacs/whole_protein_cluster_centers_0.175_900_1000ns.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_5775.pdbqt --scoring vinardo --center_x -0.675 --center_y 3.513 --center_z -8.578 --size_x 29.25 --size_y 25.5 --size_z 29.25 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_CcOctB2R.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_CcOctB2R.log 2>&1 & 
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_CcOctB2R.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-protein-lipid-bilayer-complex/gromacs/whole_protein_cluster_centers_0.175_900_1000ns.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_8969.pdbqt --scoring vinardo --center_x -0.675 --center_y 3.513 --center_z -8.578 --size_x 29.25 --size_y 25.5 --size_z 29.25 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_CcOctB2R.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_CcOctB2R.log 2>&1 & 
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_CcOctB2R.pdbqt
        ...
        """, language="bash")
        # ----LOAD GRID DIMENSION FILE OF CcOctB2R----
        # Check if the file exists before reading
        if grid_dimension.exists():
            with open(grid_dimension, "rb") as script_file:
                script_byte = script_file.read()

            # Add download button
            st.download_button(
                label="Download AutoDock4 Grid Dimension File of CcOctB2R",
                data=script_byte,
                file_name=grid_dimension.name,  # Extract just the file name
                mime="application/x-sh",  # MIME type for shell scripts
            )
        else:
        ...
        st.markdown("[Watch Youtube Video to learn how to perform molecular docking using AutoDock4](https://www.youtube.com/watch?v=xzH9R4FvR5w)")
        st.markdown("[Watch Youtube Video to learn how to perform molecular docking using AutoDock Vina](https://www.youtube.com/watch?v=cdjWCf-YJsc)")
        ...
        ./vina_split_1.2.7_linux_x86_64 --version
        """, language="bash")
        st.write("✔️load the AutoDock4-prepared 2RH1 crystal structure into the AutoDock MGL Tools interface, followed by selecting all the ligand binding residues and setting a grid box to cover all of the selected residues to output a grid dimension file containing the size and xyz coordinates of the grid box")
        st.code("""
        select site, resi 116+120+121+124+200+206+210+211+214+421+424+425+428+443+447+451
        print(cmd.centerofmass("site")) # you obtained the xyz coordinates of the grid box [-29.977997712167152, 10.079661818273852, 8.144114541909149], where these xyz coordinates of the grid box can be straight away used as an input for both AutoDock4 and AutoDock Vina
        print(cmd.get_extent("site")) # you obtained the xyz minimum and maximum sizes of the grid box [[-41.176998138427734, 0.7850000262260437, -1.7230000495910645], [-19.420000076293945, 18.31100082397461, 18.57900047302246]]. Base Size Formula:Size(base) = Coordinate(max) - Coordinate(min). Vina Size Formula (with Buffer):Size(Vina) = Size(base) + Buffer(5 angstrom). Grid Points = Size(Vina)/Grid Spacing(angstrom). 
        """, language="bash")
        st.write("✔️perform molecular docking via AutoDock Vina")
        st.code("""
        mkdir -p Conformer3D_COMPOUND_CID_1480785 Conformer3D_COMPOUND_CID_18526103 Conformer3D_COMPOUND_CID_19606232 Conformer3D_COMPOUND_CID_255273 Conformer3D_COMPOUND_CID_26451 Conformer3D_COMPOUND_CID_26752 Conformer3D_COMPOUND_CID_4184 Conformer3D_COMPOUND_CID_4581 Conformer3D_COMPOUND_CID_577782 Conformer3D_COMPOUND_CID_76145148 Conformer3D_COMPOUND_CID_36324 Conformer3D_COMPOUND_CID_36326 Conformer3D_COMPOUND_CID_2726 Conformer3D_COMPOUND_CID_5775 Conformer3D_COMPOUND_CID_8969 # create a list of ligand directories first before running AutoDock Vina to organize the docking results systematicaly
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_2726.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_2RH1.log 2>&1 & # run this command in the working directory containing the installed executable AutoDock Vina package, /media/raid/Wee/WeeYeZhi/output/autodockvina_installation
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_2726/Conformer3D_COMPOUND_CID_2726_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_5775.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_2RH1.log 2>&1 & 
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_5775/Conformer3D_COMPOUND_CID_5775_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_8969.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_2RH1.log 2>&1 & 
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_8969/Conformer3D_COMPOUND_CID_8969_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_36324.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36324/Conformer3D_COMPOUND_CID_36324_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36324/Conformer3D_COMPOUND_CID_36324_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36324/Conformer3D_COMPOUND_CID_36324_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_36326.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36326/Conformer3D_COMPOUND_CID_36326_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36326/Conformer3D_COMPOUND_CID_36326_2RH1.log 2>&1 & 
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_36326/Conformer3D_COMPOUND_CID_36326_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_1480785.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785/Conformer3D_COMPOUND_CID_1480785_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785/Conformer3D_COMPOUND_CID_1480785_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_1480785/Conformer3D_COMPOUND_CID_1480785_2RH1.pdbqt
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_18526103.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103/Conformer3D_COMPOUND_CID_18526103_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103/Conformer3D_COMPOUND_CID_18526103_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_18526103/Conformer3D_COMPOUND_CID_18526103_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_19606232.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_19606232/Conformer3D_COMPOUND_CID_19606232_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_19606232/Conformer3D_COMPOUND_CID_19606232_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_19606232/Conformer3D_COMPOUND_CID_19606232_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_255273.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_255273/Conformer3D_COMPOUND_CID_255273_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_255273/Conformer3D_COMPOUND_CID_255273_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_255273/Conformer3D_COMPOUND_CID_255273_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_26451.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26451/Conformer3D_COMPOUND_CID_26451_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26451/Conformer3D_COMPOUND_CID_26451_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26451/Conformer3D_COMPOUND_CID_26451_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_26752.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26752/Conformer3D_COMPOUND_CID_26752_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26752/Conformer3D_COMPOUND_CID_26752_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_26752/Conformer3D_COMPOUND_CID_26752_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_4184.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4184/Conformer3D_COMPOUND_CID_4184_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4184/Conformer3D_COMPOUND_CID_4184_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4184/Conformer3D_COMPOUND_CID_4184_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_4581.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4581/Conformer3D_COMPOUND_CID_4581_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4581/Conformer3D_COMPOUND_CID_4581_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_4581/Conformer3D_COMPOUND_CID_4581_2RH1.pdbqt 
        nohup ./vina_1.2.7_linux_x86_64 --receptor /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/2RH1_structure/2RH1.pdbqt --ligand /media/raid/Wee/WeeYeZhi/output/latest_ligand_preparation_results/autodock_mgltools_results/Conformer3D_COMPOUND_CID_577782.pdbqt --scoring vinardo --center_x -29.978 --center_y 10.080 --center_z 8.144 --size_x 26.76 --size_y 22.52 --size_z 25.30 --spacing 0.375 --seed 12345 --out /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_577782/Conformer3D_COMPOUND_CID_577782_2RH1.pdbqt --cpu 16 --exhaustiveness 64 --energy_range 5 --num_modes 15 > /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_577782/Conformer3D_COMPOUND_CID_577782_2RH1.log 2>&1 &
        ./vina_split_1.2.7_linux_x86_64 --input /media/raid/Wee/WeeYeZhi/output/molecular_docking_with_2RH1_results/autodock_vina_results/Conformer3D_COMPOUND_CID_577782/Conformer3D_COMPOUND_CID_577782_2RH1.pdbqt 
        ...
        alter resn UNL, chain="B"
        alter resn UNL, resn="AMZ"
        sort
        """, language="bash")
        st.write("✔️extract the ligand coordinates from the AutoDock Vina-derived protein-ligand complex structure (.pdb) and convert it to .mol2 file while adding hydrogens to use this ligand mol2 file for CHARMM-GUI to prepare your ligand topology")
        st.code("""
        grep AMZ /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_36324/CcOctB2R_36324_complex.pdb > /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.pdb 
        obabel PubChem_36324.pdb -O PubChem_36324.mol2 -h # run export PATH="/media/raid/Wee/WeeYeZhi/output/obabel_installation/bin:$PATH" first to export obabel into the PATH environment
        """, language="bash")
        st.write("✔️change the directory ownership from 500 to cbr15 to solve the directory permission issue")
        st.code("""
        sudo chown -R cbr15:cbr15 /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-protein-36324-lipid-bilayer-complex # remember to run this command as a root user
        """, language="bash")
        st.write("✔️invoke the grompp and mdrun programme to run energy minimization of the receptor-ligand-lipid-bilayer complex system to lower the overall potential energy of the system by removing overlapping atoms, steric clashes, suboptimal hydrogen bonding, and bad contacts")
        st.code("""
        nohup gmx grompp -f step6.0_minimization.mdp -c step5_input.gro -r step5_input.gro -p topol.top -o em.tpr > em_tpr.log 2>&1 & # navigate to the working directory, /media/raid/Wee/WeeYeZhi/output/charmmgui_results/charmm-gui-protein-ligand-lipid-bilayer-complex/gromacs, before you run the command
        nohup gmx mdrun -deffnm em -nb gpu > em_mdrun.log 2>&1 & # run the calculation for non-bonded atomic interactions, PME electrostatic interactions, bonded interactions, and coordinate update/integration on GPU to accelerate the overall MD simulation process
        gmx energy -f em.edr -o potential.xvg # execute the energy command to extract the potential energy (as a function of energy minimization step) of the system from the generated binary energy file (.edr). Select 13 (Potential) and 0 (to terminate input). Based on the potential energy plot, you will notice that the potential energy of the system drops dramatically in the first few steps as water molecules rearrange to optimize hydrogen bonding
        """, language="bash")
        ...
        st.write("✔️invoke the grompp and mdrun programme to run NVT and NPT equilibration of the receptor-ligand-lipid bilayer complex system to bring the whole system to a stable temperature and pressure")
        st.code("""
        nohup gmx grompp -f step6.1_equilibration.mdp -c em.gro -r em.gro -p topol.top -n index.ndx -o step6.1.tpr > step6.1_tpr.log 2>&1 & # run first NVT equilibration
        nohup gmx mdrun -s step6.1.tpr -deffnm step6.1 -nb gpu -pme gpu -bonded gpu -update gpu > step6.1_mdrun.log 2>&1 &
        nohup gmx grompp -f step6.2_equilibration.mdp -c step6.1.gro -r step6.1.gro -t step6.1.cpt -p topol.top -n index.ndx -o step6.2.tpr > step6.2_tpr.log 2>&1 & # run second NVT equilibration
        ...
        st.write("✔️run the MD production simulation for 500 ns")
        st.code("""
        ...
        st.write("✔️create an index group for TM helices only. Expect to observe lower RMSD values since loops no longer dominate the motion, termini no longer inflate RMSD, and only the GPCR core is measured")
        st.code("""
        gmx make_ndx -f protein_ligand_complex.tpr -n index.ndx -o index.ndx # create the index for TM helices of the protein. Type, r 31-54 | r 66-87 | r 104-125 | r 146-167 | r 188 | r 190 | r 194 | r 195-215 | r 279-298 | r 311-334, and press "Enter", followed by typing, name 19 TM-helices, to rename the newly created index group as TM-helices and position the newly created index group as 19. Type "q" to quit
        gmx make_ndx -n index.ndx -f protein_ligand_complex.tpr -o index.ndx # create the index for the backbone of TM helices of the protein. Type, 19 & 4 (19 indicates TM-helices and 4 indicates Backbone), and press "Enter", followed by typing, name 20 TM-helices-backbone, to rename the newly created index group as TM-helices-backbone and position the newly created index group as 20. Type "q" to quit
        """, language="bash")

        st.write("###")

        st.code("""
        gmx trjconv -s protein_ligand_complex.tpr -f protein_ligand_complex_fit.xtc -n index.ndx -b 250000 -e 350000 -o whole_protein_only_250_350ns.xtc # Select 0 (0 indicates system, which means the whole protein_ligand_complex since your input is a protein_ligand_complex.tpr). 
        gmx cluster -s protein_ligand_complex.tpr -f whole_protein_only_250_350ns.xtc -n index.ndx -method gromos -cutoff 0.175 -o whole_protein_clusters_0.175_250_350ns.xpm -g whole_protein_cluster_0.175_250_350ns.log -cl whole_protein_cluster_centers_0.175_250_350ns.pdb -dist whole_protein_rmsd_dist_0.175_250_350ns.xvg # Select group for least squares fit: TM-helices-backbone and select group for RMSD calculation: TM-helices-backbone. Select 0 (protein_ligand_complex) for output. The cutoff value is in the unit of nm and 1 nm = 10 angstrom. In this instance, the clusters.xpm file contains the cluster assignment map; cluster.log file contains the cluster statistics; cluster_centers.pdb file contains the representative structures; and the rmsd_dist.xvg file plots the RMSD distribution graph. Found 1 cluster only.
        gmx trjconv -s protein_ligand_complex.tpr -f protein_ligand_complex_fit.xtc -n index.ndx -b 900000 -e 1000000 -o whole_protein_only_900_1000ns.xtc # Select 0 (0 indicates system, which means the whole protein_ligand_complex since your input is a protein_ligand_complex.tpr).
        gmx cluster -s protein_ligand_complex.tpr -f whole_protein_only_900_1000ns.xtc -n index.ndx -method gromos -cutoff 0.175 -o whole_protein_clusters_0.175_900_1000ns.xpm -g whole_protein_cluster_0.175_900_1000ns.log -cl whole_protein_cluster_centers_0.175_900_1000ns.pdb -dist whole_protein_rmsd_dist_0.175_900_1000ns.xvg # Select group for least squares fit: TM-helices-backbone and select group for RMSD calculation: TM-helices-backbone. Select 0 (protein_ligand_complex) for output. The cutoff value is in the unit of nm and 1 nm = 10 angstrom. In this instance, the clusters.xpm file contains the cluster assignment map; cluster.log file contains the cluster statistics; cluster_centers.pdb file contains the representative structures; and the rmsd_dist.xvg file plots the RMSD distribution graph. Found 1 cluster only.
        ...
        st.write("✔️calculate the backbone RMSD of TM-helices and the ligand RMSD respectively to investigate how much did the protein structure and the ligand structure deviate from the reference structure over time to determine structural stability, equilibration quality, large conformational changes, and simulation convergence. To answer questions like does the insect receptor structure maintain its structure? does the binding pocket collapse? does the transmembrane region stay stable?")
        st.code("""
        gmx rms -s protein_ligand_complex.tpr -f protein_ligand_complex_fit.xtc -n index.ndx -tu ns -o tm_helices_rmsd.xvg # Select group for least squares fit: TM-helices-backbone and Select group for RMSD calculation: TM-helices-backbone
        ...
        gmx_MMPBSA -v
        """, language="bash")
        st.write("✔️test your gmxMMPBSA run")
        st.code("""
...
if selected == "Additional Notes":
    with st.container():
        ...
        st.code("""
        grep UNL /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_36324/CcOctB2R_36324_complex.pdb > /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.pdb # extract the ligand (.pdb) from the protein-ligand complex. In this case, the ligand was named as UNL by the Pymol software itself.
        sed -i 's/UNL/AMZ/g' /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.pdb # change all the UNL entries to AMZ (a three letter code that i set personally for amitraz)
        grep -v UNL /media/raid/Wee/WeeYeZhi/output/molecular_docking_results/autodock_vina_results/simulation_900_1000ns/Conformer3D_COMPOUND_CID_36324/CcOctB2R_36324_complex.pdb > /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R.pdb # obtain a clean protein (.pdb) file from the protein-ligand complex
        """, language="bash")
        st.write("✔️download the latest CHARMM36 force field tarball and 'cgenff_charmm2gmx.py' script")
        st.code("""
        python --version # check the Python version that you are currently using
        python -c "import networkx; print(networkx.__version__)" # check the NetworkX version that you are using to determine which version of the cgenff_charmm2gmx.py script that you should download
        tar -xzvf /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CHARMM36_forcefield_script/charmm36-feb2026_cgenff-5.0.ff.tgz
        """, language="bash")
        st.write("✔️prepare the topology of the protein in GROMACS (.gro) format via pdb2gmx")
        st.code("""
        gmx pdb2gmx -h # output the command-line usage manual of pdb2mgx
        gmx pdb2gmx -f /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R.pdb -o /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R_processed.gro -p /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/topol.top -water tip3p -ignh -ter # remember to run this command in the working directory containing the extracted charmm36 forcefield directory, /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CHARMM36_forcefield_script so that the gmx pdb2gmx command is able to detect the newly downloaded CHARMM36 forcefield as one of the forcefield selections in the list. After running this command, type 1 (From current directory: 1. CHARMM all-atom force field), followed by typing 1 (1:NH3+) to select the start terminus type for MET-1, and typing 0 (0: COO-) to select the end terminus type for the last amino acid residue of your input protein,LEU-390). Remember to specify -ignh to let CHARMM36 to rename all the hydrogen atoms using its own hydrogen naming convention, otherwise GROMACS will crash since the hydrogen naming convention of the PDB file is different compared to the CHARMM36 ones.
        """, language="bash")
        st.write("✔️prepare the topology of the ligand in GROMACS (.gro) format via obabel and CGenFF")
        st.code("""
        export PATH='/media/raid/Wee/WeeYeZhi/output/obabel_installation/bin:$PATH'
        obabel /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.pdb -O /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.mol2 -h # convert the ligand from PDB to MOL2 format as well as adding hydrogens to be used as an input for CGenFF server to generate the CHARMM36 forcefield parameters for the ligand.
        wget http://www.mdtutorials.com/gmx/complex/Files/sort_mol2_bonds.txt # download the sort_mol2_bonds.txt over the internet via online
        mv sort_mol2_bonds.txt sort_mol2_bonds.pl # rename the file extension from .txt to .pl 
        chmod +x sort_mol2_bonds.pl # make the perl script executable
        perl /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/script/sort_mol2_bonds.pl /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324.mol2 /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/PubChem_36324_fix.mol2 # arrange the bonds of the ligand so that the atom number of bonds appears in ascending order using the perl script
        upload the fixed PubChem_36324_fix.mol2 file into CGenFF server v5.0 () to generate the ligand topology files
        download the CHARMM stream topology file (.str) returned by the CGenFF server as the stream file contains all of the topology information such as atom types, charges, and bonded connectivity
        click 'Convert to GROMACS format' in the CGenFF server and download the topology of the ligand in GROMACS format (.zip)
        unzip PubChem_36324_fix_gromacs.zip # unzip the CGenFF GROMACS results folder
        cp PubChem_36324_fix_gmx.top PubChem_36324_fix_gmx.itp 
        nano PubChem_36324_fix_gmx.itp # modify the content of the .itp file according to the GROMACS tutorial at http://www.mdtutorials.com/gmx/complex/02_topology.html
        gmx editconf -f PubChem_36324_fix_gmx.pdb -o PubChem_36324_fix_gmx.gro
        cp CcOctB2R_processed.gro CcOctB2R_36324_complex.gro 
        copy the ligand coordinates from the PubChem_36324_fix_gmx.gro file and paste it to the newly created CcOctB2R_36324_complex.gro file 
        remember to add the total number of added ligand atoms to the protein_ligand_complex.gro file
        modify the topol.top file to add the ligand molecule name to the 'molecules' directive and include the forcefield of the ligand
        """, language="bash")
        st.write("✔️define box and solvate")
        st.code("""
        gmx editconf -f /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R_36324_complex.gro -o /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R_36324_complex_newbox.gro -bt dodecahedron -d 1.0
        gmx solvate -cp /media/raid/Wee/WeeYeZhi/output/MD_simulation_of_protein_ligand_complex/CcOctB2R_36324_complex/CcOctB2R_36324_complex_newbox.gro -cs spc216.gro -p topol.top -o CcOctB2R_36324_complex_solv.gro
        """, language="bash")
        st.markdown("[Download the latest CHARMM36 force field tarball and 'cgenff_charmm2gmx.py' script](https://mackerell.umaryland.edu/charmm_ff.shtml#gromacs)")
